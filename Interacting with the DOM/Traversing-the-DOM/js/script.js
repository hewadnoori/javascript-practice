...
const firstItem = list.firstElementChild; console.log(firstItem);
firstItem.style.backgroundColor = '#04c5e6';

// 2: Using traversal, store the second list item in a variable named `nextItem`
const nextItem = firstItem.nextElementSibling; console.log(nextItem);
...
const wrapper = list.parentElement; console.log(wrapper);
